...
from processing_functions import altitude, time_averages
from processing_functions import calc_specific_humidity, calc_pseudopot_temp, boundary_layer_height, smooth_variable, read_lidar, interpolate_lidar_data, calc_virt_pot, calc_bulk_richardson, read_lidar_pkl, boundary_layer_height_from_ri
#from plot_functions import profile_plot_series
...
data_path = 'C:/Users/there/Documents/Arduino/LEX_2018_lokal/Daten/alpaka/data/20180903_Grenzschichtentwicklung/'
...
z_BL = boundary_layer_height_from_ri(Ri, z_levels)
# calculate gradients
